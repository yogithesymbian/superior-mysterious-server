#!/bin/bash
# setup_main_domain_safe.sh
# Initialize main domain with Nginx and SSL (keeps existing sites & SSL certs)
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Main Domain Setup (Safe - Keeps Existing)"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
echo "✓ Existing Nginx sites will be kept"
echo "✓ Existing SSL certificates will be kept"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
# Create or update Nginx config (does not overwrite existing config)
ok "Creating Nginx configuration..."

# Check if default config already exists
if [ -f /etc/nginx/sites-available/default ]; then
    warn "Nginx default config already exists - backing up to default.bak"
...
if [ -d /etc/letsencrypt/live/$MAIN_DOMAIN ]; then
    warn "SSL certificate for $MAIN_DOMAIN already exists - skipping certbot"
else
    # Run certbot with manual SSL setup
